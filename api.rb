...
if limit == 0
  print_recipe(api_return[offset])
else
  (offset..limit).each do |idx|
    break unless api_return[idx] # Para se idx ultrapassar o tamanho do array
    print_recipe(api_return[idx])
  end
end
